...
all : .SYMBOLIC $(OBJS)\ifacecheck.exe
...
$(OBJS)\ifacecheck.exe :  $(IFACECHECK_OBJECTS)
	@%create $(OBJS)\ifacecheck.lbc
	@%append $(OBJS)\ifacecheck.lbc option quiet
	@%append $(OBJS)\ifacecheck.lbc name $^@
	@%append $(OBJS)\ifacecheck.lbc option caseexact
	@%append $(OBJS)\ifacecheck.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt ref 'main_' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(IFACECHECK_OBJECTS)) do @%append $(OBJS)\ifacecheck.lbc file %i
	@for %i in ( $(__WXLIB_XML_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_PNG_IF_MONO_p) wxzlib$(WXDEBUGFLAG).lib wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__CAIRO_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib wininet.lib) do @%append $(OBJS)\ifacecheck.lbc library %i
	@%append $(OBJS)\ifacecheck.lbc
	@for %i in () do @%append $(OBJS)\ifacecheck.lbc option stack=%i
	wlink @$(OBJS)\ifacecheck.lbc

$(OBJS)\ifacecheck_ifacecheck.obj :  .AUTODEPEND .\ifacecheck.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(IFACECHECK_CXXFLAGS) $<

$(OBJS)\ifacecheck_xmlparser.obj :  .AUTODEPEND .\xmlparser.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(IFACECHECK_CXXFLAGS) $<
